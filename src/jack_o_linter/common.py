...
class APIWrapper(ABC):
    ...
    def run(self, target: Path, *args: Any, **kwargs: Any) -> None:
        ...
        Args:
            target (Path): The file or dir to run the tool against.
            *args (Any): Positional arguments.
            **kwargs (Any): Keyword arguments.
        """

    def get_errors(self) -> Optional[List[str]]:
        """Get the errors generated by the analysis tool.

        Returns:
            Optional[List[str]]: List of errors
        """
        self._validate_results()

        return self.errors

    def get_warnings(self) -> Optional[List[str]]:
        """Get the warnings generated by the analysis tool.

        Returns:
            Optional[List[str]]: List of warnings
        """
        self._validate_results()
    ...
    def get_score(self) -> Optional[float]:
        ...
        Returns:
            Optional[float]: Score out of 100. 100 is perfect.
        """
        self._validate_results()
        return self.score
    ...
    def _convert_args_to_list(self, target: Path, *args: Any, **kwargs: Any) -> List[str]:
